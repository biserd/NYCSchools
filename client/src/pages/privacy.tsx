      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>When you submit a Parent Assistant request, Cloudflare briefly queues it so the WhatsApp webhook can acknowledge receipt immediately. The request, recent conversation context, today's date and your timezone are processed by Cloudflare Workers AI. When needed, the assistant calls limited school and calendar tools; only the records required to answer the request are returned to that model turn. Phone numbers, full account records and unrelated family records are not sent to the model. You review and confirm calendar changes.</p>
            <p>The stateful assistant stores at most the 30 most recent conversation messages in a private, per-account Cloudflare Durable Object so website and WhatsApp conversations can share context. Messages older than 90 days are removed on the next request, and “Start a new assistant conversation” clears this state immediately. Website chat sessions shown in account settings may separately be retained for up to 90 days. Operational telemetry—model, tool category, non-sensitive filters, result count, outcome and latency, but not message or response content—is retained for up to 90 days. Drafts expire after ten minutes and are removed by scheduled maintenance after a one-day retry window. Delivery records are retained for up to 90 days, message receipt identifiers for seven days, and daily usage counts for 35 days. Calendar records remain until removed or the account is deleted. Test environments may retain records until their next cleanup.</p>
          </section>
