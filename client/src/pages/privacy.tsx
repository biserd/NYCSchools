      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>When you submit a Parent Assistant request, Cloudflare briefly queues it so the WhatsApp webhook can acknowledge receipt immediately. Clear school searches are resolved directly against our database; requests that need interpretation send the request, today's date, your timezone and—when needed for a follow-up—short-lived structured filters such as neighborhood, grade, requested programs and prior result identifiers to Cloudflare Workers AI. Child records, calendar contents, phone numbers and full account records are not sent to the model. You review and confirm calendar changes. We do not store message text or a full Parent Assistant conversation transcript in our database; provider retention is governed by their policies.</p>
