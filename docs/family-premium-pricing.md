...
This release is staging-first. Do not promote until the new one-time Stripe price is configured and checkout is verified.

## Offers

| Plan | Price | Entitlement |
|---|---|---|
| School Research Pass | $29.99 once | Six calendar months of existing school-research tools, including on-site AI chat. No renewal. |
...
- Configure a new verified $29.99 USD one-time price on the approved Research Pass product, with correct customer-facing product name. Update `STRIPE_SEASON_PASS_PRICE_ID` only after verification. Runtime validation refuses a price that differs from the displayed amount. The production deployment guard rejects the old $29.00 price.
