...
const prod='https://nycschoolsratings.com',stage='https://nyc-schools-ratings-d1-staging.biser-d.workers.dev';
...
await writeFile('.wrangler/d1-public-parity.json',JSON.stringify(report,null,2));
