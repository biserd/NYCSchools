/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.d1-staging.jsonc --strict-vars=false` (hash: 5e84bf1b6f363d3daa9d86273c1f7af9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PARENT_WHATSAPP_ENABLED" | "TWILIO_WHATSAPP_FROM" | "NODE_ENV" | "APP_URL" | "ADMIN_EMAILS" | "EMAIL_DELIVERY_ENABLED" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "STRIPE_SEASON_PASS_PRODUCT_ID" | "STRIPE_SEASON_PASS_PRICE_ID" | "STAGING_EXPIRES_AT">> {}
}
