/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.d1-staging.jsonc --strict-vars=false` (hash: 5cb6cad7272a83bfe4d7f367b16054b0)
// Runtime types generated with workerd@1.20260828.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	...
	PARENT_ASSISTANT_AGENT: DurableObjectNamespace<import("./server/index-d1-staging").ParentAssistantAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index-d1-staging");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PARENT_WHATSAPP_ENABLED" | "PARENT_ASSISTANT_ENABLED" | "PARENT_AGENT_SDK_ENABLED" | "PARENT_REMINDERS_ENABLED" | "FAMILY_CHECKOUT_ENABLED" | "PARENT_LAUNCH_VERIFIED" | "PARENT_REMINDER_CONTENT_SID" | "PARENT_AGENT_QUEUE_NAME" | "TWILIO_WHATSAPP_FROM" | "NODE_ENV" | "APP_URL" | "ADMIN_EMAILS" | "EMAIL_DELIVERY_ENABLED" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "STRIPE_FAMILY_PREMIUM_PRICE_ID" | "STRIPE_SEASON_PASS_PRODUCT_ID" | "STRIPE_SEASON_PASS_PRICE_ID" | "STAGING_EXPIRES_AT">> {}
}
